---
type: Reference
title: BeerGaao-Web 项目说明
description: BeerGaao 全栈 Web 应用项目说明——技术栈、目录结构、快速开始、数据源与功能概览。
tags: [project, beergaao, react, stock, frontend]
...
- [K线颜色修正 - 中国市场标准](/Project/beergaao/K线颜色修正.md) — K线颜色修正记录
